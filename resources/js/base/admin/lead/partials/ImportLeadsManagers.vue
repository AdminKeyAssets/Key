    ...
    methods: {
        ...
        async uploadLeads() {
            ...
            try {
                ...
                await axios.post('/lead/import-manager', formData, {
                    headers: {
        ...
        async exportSampleFile() {
            try {
                ...
                const response = await axios.get('/lead/export-import-manager-sample', {
                    responseType: 'blob'
                });
                const url = window.URL.createObjectURL(new Blob([response.data]));
                const link = document.createElement('a');
                link.href = url;
                link.setAttribute('download', 'sample_leads_manager.xlsx');
