    ...
    methods: {
        ...
        processComments() {
            this.comments.forEach(comment => {
                ...
                if (url) {
                    // If the URL is a direct image link, use it as the preview image
        ...
        async fetchComments() {
            try {
                const response = await axios.get(`/lead/${this.id}/comments`);
        ...
        async deleteComment(commentId) {
            this.$confirm('Are you sure?', 'You are deleting a comment', {
                ...
                try {
                    const response = await axios.post(`/lead/${this.id}/comments/delete/${commentId}`);
        ...
        async submitComment() {
            ...
            const url = `/lead/${this.id}/comments`;
            try {
