        ...
        <ul class="comments-list">
            <li v-for="comment in visibleComments" :key="comment.id"
                ...
                <div class="comment-header">
                    <span class="comment-user" v-if="comment.author_name">{{ comment.author_name }}</span>
...
export default {
    ...
    methods: {
        ...
        async fetchComments() {
            await axios.get(`/lead/${this.id}/comments`).then(response => {
        ...
        async deleteComment(commentId) {
            this.$confirm('Are you sure?', 'You are deleting a comment', {
                ...
                await axios.post(`/lead/${this.id}/comments/delete/${commentId}`).then(response => {
