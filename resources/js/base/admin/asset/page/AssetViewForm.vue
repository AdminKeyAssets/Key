                                ...
                                <el-tabs v-model="activeNames">
                                    ...
                                    <el-tab-pane label="Asset Details" name="2">
                                        ...
                                        <div v-if="form.investor_id" class="form-group dashed">
                                            ...
                                            <div class="col-md-10 uppercase-medium">
                                                <el-select v-model="form.investor_id" disabled :value="form.investor_id" filterable placeholder="Select">
                                                    <el-option v-for="item in investors" :key="item.id" :label="item.name" :value="item.id"></el-option>
                                                </el-select>
                                            </div>
                                        </div>
                                        ...
                                        <div v-if="form.floor_plan" class="form-group dashed">
                                            ...
                                            <div class="col-md-10 uppercase-medium">
                                                <div v-if="form.floor_plan">
                                                    <ImageModal v-if="form.floorPlanPreview" :image-path="form.floorPlanPreview" :thumbnail="form.floorPlanPreview"></ImageModal>
                                                    <ImageModal v-else :image-path="form.floor_plan" :thumbnail="form.floor_plan"></ImageModal>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div v-if="form.flat_plan" class="form-group dashed">
                                            ...
                                            <div class="col-md-10 uppercase-medium">
                                                <div v-if="form.flat_plan">
                                                    <ImageModal v-if="form.flatPlanPreview" :image-path="form.flatPlanPreview" :thumbnail="form.flatPlanPreview"></ImageModal>
                                                    <ImageModal v-else :image-path="form.flat_plan" :thumbnail="form.flat_plan"></ImageModal>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <el-tab-pane v-if="form.attachments.length || form.extraDetails.length" label="Extra" name="3">
